...
const filterData = (req) => {
    ...
    if (req.query.created_course) {
        $where["created_course"] = {
            gte: new Date(req.query.created_course + " 00:00:00").toISOString(),
            lte: new Date(req.query.created_course + " 23:59:00").toISOString(),
        };
    }
        ...
        try {
            const item = await prisma[table].create({
                data: {
                    ...
                    created_course: new Date(req.body.created_course),
                    created_by: "arnonr",
                    updated_by: "arnonr",
                },
            });
                ...
                data: {
                    ...
                    is_publish:
                        req.body.is_publish != null
                            ...
                            : undefined,
                    created_course:
                        req.body.created_course != null
                            ? new Date(req.body.created_course)
                            : undefined,
                    updated_by: "arnonr",
                },
            });
