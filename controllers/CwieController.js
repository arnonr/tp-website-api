...
const filterData = (req) => {
    ...
    if (req.query.created_cwie) {
        $where["created_cwie"] = {
            gte: new Date(req.query.created_cwie + " 00:00:00").toISOString(),
            lte: new Date(req.query.created_cwie + " 23:59:00").toISOString(),
        };
    }
        ...
        try {
            const item = await prisma[table].create({
                data: {
                    ...
                    created_cwie: new Date(req.body.created_cwie),
                    created_by: "arnonr",
                    updated_by: "arnonr",
                },
            });
                ...
                data: {
                    ...
                    is_publish:
                        req.body.is_publish != null
                            ...
                            : undefined,
                    created_cwie:
                        req.body.created_cwie != null
                            ? new Date(req.body.created_cwie)
                            : undefined,
                    updated_by: "arnonr",
                },
            });
